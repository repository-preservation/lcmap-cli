...
{:http-options  {:timeout 2400000}
 :grids {:conus  {:ard "http://host:port/path/resource"
                  :aux "http://host:port/path/resource"
                  :ccdc "http://host:port/path/resource"
                  :grid "/grid"
                  :snap "/grid/snap"
                  :near "/grid/near"
                  :inventory "/inventory"
                  ...
                  :product-month "07"
                  :product-day "01"}
         :alaska {:ard "http://host:port/path/resource"
                  :aux "http://host:port/path/resource"
                  :ccdc "http://host:port/path/resource"
                  :grid "/grid"
                  :snap "/grid/snap"
                  ...
                  :product-month "07"
                  :product-day "01"}
         :hawaii {:ard "http://host:port/path/resource"
                  :aux "http://host:port/path/resource"
                  :ccdc "http://host:port/path/resource"
                  :grid "/grid"
                  :snap "/grid/snap"
